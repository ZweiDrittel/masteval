//Programm, um Daten aus Windmessmast auszuwerten
//Es werden für die Begehungszeiten Mittelwerte des Windgeschwindigkeit erstellt
//Die minütlichen Messwerte werden ebenfalls festgehalten
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
point_in_time *setTo(point_in_time *time)
{
	...
	another_time = malloc(sizeof(point_in_time));
...
////////////////////////////////////////////////////////////////////////
	...
	while(go_on)
	{
		...
		point_in_time *start_of_inspection = malloc(sizeof(point_in_time));
